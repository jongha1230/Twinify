...
const CommentPage = () => {
  const usr = { nickname: "새청바지" };
  return (
    <article className=" w-4/5">
      <section>
        <h2 className="text-white text-2xl font-bold mb-5">댓글</h2>
        <div className="bg-surfaceDark p-5 rounded-md">
          <p className="text-white font-bold mb-4">{usr.nickname}</p>
          <textarea className="bg-surfaceDark text-white resize-none w-full" placeholder="노래의 소감을 작성해주세요 :)" />
      ...
      <section className="py-10 text-white flex justify-between border-b">
        <div className="flex">
          ...
          <div className="ml-4 mt-4">
            <h4 className="mb-4 text-lg font-semibold">{usr.nickname}</h4>
