    ...
    <>
      {isEditing ? (
        ...
        <section className="py-10 text-white flex justify-between border-b">
          <div className="flex">
            <div>
              <Image src={commentUser.profileImg || "/defaultProfile.webp"} width={50} height={50} alt="profile-img" className="rounded-full " />
            </div>
            <div className="ml-4 mt-3">
              <h4 className="mb-4 text-lg font-semibold">{commentUser.nickname}</h4>
